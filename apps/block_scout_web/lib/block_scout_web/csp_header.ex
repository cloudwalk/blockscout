  ...
  def call(conn, _opts) do
    Controller.put_secure_browser_headers(conn, %{
      "content-security-policy" => "\
        ...
        default-src 'self';\
        script-src 'self' 'sha256-iiPiBqDYN6CjcYJFb4xi5A5f1Iv/6krJ2bjU1p5oinY=' 'sha256-QADITpnBuiXVfTzrfwP9VzAxptWL1j2UNMPM72SNEno=' 'sha256-S+kA9ZZC2ANiKZW1Soge1NhdxH9M4c2UTARyyzpLBio=' 'sha256-fqGNTzWau5hfYKKH3B59dBNOSh8VdaIQ5YXzH+9C0Ys=' 'sha256-89/1LLiXXHmqi3EdeHqEQ7Kz1VVc+6OXCUaen1kiUfg=' 'sha256-IBxcGAt2latSKF1Je/SHpNwTeU5Q1WKiBVNd13xlAiA=' 'sha256-bA0SJeg1gTpu+3isk3u6dVrrwpPIjqHTlaOZf3Rbks0=' *.google.com *.gstatic.com;\
